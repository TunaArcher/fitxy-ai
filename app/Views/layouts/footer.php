<!-- <footer class="adminuiux-mobile-footer hide-on-scrolldown style-1">
    <div class="container">
        <ul class="nav nav-pills nav-justified">
            <li class="nav-item">
                <a class="nav-link" href="fitness-dashboard.html"><span><i class="nav-icon bi bi-columns-gap"></i>
                        <span class="nav-text">Home</span></span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="fitness-workout.html"><span><svg
                        ...
                        <span class="nav-text">Workout</span></span></a>
            </li>
            <li class="nav-item">
                <a href="fitness-diet.html" class="nav-link"><span><svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="nav-icon"
                        ...
                        <span class="nav-text">Diet</span></span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="fitness-report.html"><span><i class="nav-icon bi bi-graph-up-arrow"></i>
                        <span class="nav-text">Report</span></span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="fitness-profile.html"><span>
                        <figure
                            class="avatar avatar-20 rounded-circle coverimg align-middle mb-2">
                            <img src="assets/img/fitness/image-6.jpg" alt="" />
                        </figure>
                        <br /><span class="nav-text">Profile</span>
                    </span></a>
            </li>
        </ul>
    </div>
...
<!-- <div class="position-fixed bottom-0 end-0 m-3 z-index-5" id="fixedbuttons">
    <button
        ...
        <i class="bi bi-palette"></i></button><br /><button
        class="btn btn-theme btn-square shadow mt-2 d-none rounded-circle"
        id="backtotop">
